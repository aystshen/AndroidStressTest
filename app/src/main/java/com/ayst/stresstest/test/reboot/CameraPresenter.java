...
public class CameraPresenter {
    ...
    public CameraPresenter(Activity activity, AutoFitTextureView view) {
        mActivity = activity;
        mTextureView = view;
    ...
    public void init() throws Exception {
        ...
        if (cameraIds.length > 0) {
            ...
            Log.w(TAG, "CameraHelper, No camera");
    ...
    private void captureStillPictureLocked() {
        try {
            ...
            // of active requests.
            ImageSaver.ImageSaverBuilder jpegBuilder = new ImageSaver.ImageSaverBuilder(mActivity)
